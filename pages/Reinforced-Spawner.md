...
## Obtaining
A Reinforced Spawner can be obtained by repairing a [Broken Spawner](https://github.com/Slimefun5/Slimefun5/wiki/Broken-Spawner) at an [Ancient Altar](https://github.com/Slimefun5/Slimefun5/wiki/Ancient-Altar). The mob type will be the same as the original spawner it came from.
