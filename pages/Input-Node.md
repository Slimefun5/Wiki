...
### Placement
A cargo input node must be placed (shift-right click) onto a container or [machine](https://github.com/Slimefun5/Slimefun5/wiki/Electric-Machines), and aligned within 6 blocks of a [cargo manager](https://github.com/Slimefun5/Slimefun5/wiki/Cargo-Manager) or a [connector](https://github.com/Slimefun5/Slimefun5/wiki/Connector-Node) in range of one (no diagonals).
