...
Placing [input](https://github.com/Slimefun5/Slimefun5/wiki/Input-Node) and [output nodes](https://github.com/Slimefun5/Slimefun5/wiki/Output-Node) on a container or machine allows the items in it to enter or exit the network, respectively. These nodes have to be in the direct range of a cargo manager, or they can be connected to one with [connector nodes](https://github.com/Slimefun5/Slimefun5/wiki/Connector-Node).
...
## Table of contents
* [Cargo Motor](https://github.com/Slimefun5/Slimefun5/wiki/Cargo-Motor)
...
* [Cargo Node (Input)](https://github.com/Slimefun5/Slimefun5/wiki/Input-Node)
* [Cargo Node (Output)](https://github.com/Slimefun5/Slimefun5/wiki/Output-Node)
* [Advanced Cargo Node (Output)](https://github.com/Slimefun5/Slimefun5/wiki/Advanced-Output-Node)
