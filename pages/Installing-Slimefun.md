...
You can click on any Slimefun5 build to see all compatible Minecraft Versions for that build.

**We generally recommend development builds over stable builds, as they are the most recent versions of Slimefun5. The stable branch is only updated once a month or even less frequent, so fixes may take quite a while to make it into these builds.**
...
After the restart, you should notice a new folder called */data-storage/* in your servers root directory. This folder contains all necessary Slimefun5 data.
...
Most of the things in this file are very self explanatory, from enabling certain items to choose how Slimefun5 Research behaves in creative mode.
Slimefun5 uses an auto-updater to check for updates periodically, if you wish to disable this, or your host has somehow disabled things like that, set it to *false*

**Items.yml*** allows you to enable or disable certain items *globally*. If you install multiple addons for Slimefun5, this file can get very big,
...
**messages.yml** contains all data for messages when using Slimefun5. You can edit what the plugin sends a player when a certain event occurs.

**Researches.yml** allows you to edit the XP Values of items in Slimefun5, as well as their names, you can also disable researching all together if you wish to allow players
the ability to use all of Slimefun5 right off the bat.

**permissions.yml** allows you to define permission nodes for Slimefun5 items to restrict the usage of items based on user's permission levels.
...
Here is a full article on how to [Optimize your Slimefun5 Server](https://github.com/Slimefun5/Slimefun5/wiki/Server-Optimizations)
...
Remember that you can also disable any Items from Addons in Slimefun5's Items.yml file.
