...
## Usage
A connector node must be aligned within 6 blocks of a [cargo manager](https://github.com/Slimefun5/Slimefun5/wiki/Cargo-Manager) or another connector in range of one, in a straight line (no diagonals).

Connector nodes extend the network's range by an additional 6 blocks. Any [input](https://github.com/Slimefun5/Slimefun5/wiki/Input-Node) and [ouput nodes](https://github.com/Slimefun5/Slimefun5/wiki/Output-Node) in that range will be connected to the network.
