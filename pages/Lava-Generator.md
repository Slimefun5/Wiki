...
## Usage
A lava generator must be placed within 7 blocks of an [Energy Regulator](https://github.com/Slimefun5/Slimefun5/wiki/Energy-Regulator), an [Energy Connector](https://github.com/Slimefun5/Slimefun5/wiki/Energy-Connector), or an [Energy Capacitor](https://github.com/Slimefun5/Slimefun5/wiki/Energy-Capacitors) in a cross format (not diagonally), and provided with the appropriate fuel.  
