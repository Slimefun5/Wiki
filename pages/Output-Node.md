...
## Obtaining
Output nodes can be crafted in groups of two in an [Enhanced Crafting Table](https://github.com/Slimefun5/Slimefun5/wiki/Enhanced-Crafting-Table).

## Usage
An output node moves items from the network into the container or [machine](https://github.com/Slimefun5/Slimefun5/wiki/Electric-Machines) on which it is placed.<br>
It must be aligned within 6 blocks of a [cargo manager](https://github.com/Slimefun5/Slimefun5/wiki/Cargo-Manager) or a [connector](https://github.com/Slimefun5/Slimefun5/wiki/Connector-Node) in range of one (in a straight line; no diagonals).
